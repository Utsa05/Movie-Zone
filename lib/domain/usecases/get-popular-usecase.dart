...
class GetPopularUsecase extends Usecase<List<MovieEntity>, NoParm> {
  final MovieRepoistories _movieRepoistories;

  GetPopularUsecase({required MovieRepoistories movieRepoistories})
      : _movieRepoistories = movieRepoistories;

  @override
  Future<Either<AppError, List<MovieEntity>>> call(NoParm parm) async {
    return await _movieRepoistories.getPopular();
  }
}
